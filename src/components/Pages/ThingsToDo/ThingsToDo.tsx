      ...
      <div className="real-page-body">
        ...
        <div className={"page-body large"}>
          ...
          <p>
            ...
            Guatemala, the country has so much beauty to offer outside of
            Antigua. Here are a few that we recommend.
          </p>
          <p>
          ...
          <p>
            ...
            tourists love to visit. It's a natural limestone bridge atop which
            is a series of stepped, turquoise pools. It's many hours drive from

  ...
  return (
    <div className="page-container">
      ...
      <div className={"page-body"} id={"faq-page"}>
        ...
        <p>
          Guatemala is in the Central Standard time zone. The current time there
          is time.
        </p>
        ...
        <p>
          It's a good idea to have some cash on you for tips, shopping, and some
          places you might encounter that don't accept credit cards.
        </p>
        <p>
        ...
        <p>
          The dress code for the wedding is formal. The dress code for the other
        ...
        <p>
          Cocktail attire with some flair! Think fancy dinner on vacation. This
          is the night to bust out the brighter colors.
        </p>

        <h4>Will the wedding take place indoors or outdoors?</h4>
        <p>
          Pray for good weather! The wedding ceremony and wedding reception will
          both be held in outdoor locations.
        </p>

        <h4>What is the weather like in Antigua?</h4>
        <p>
          Riquísimo! The average maximum daytime temperature is around 80°F. The
          average minimum temperature in Antigua Guatemala in March is 59°F.
          March is a dry month with an average of 0.3 inches of rain across an
          average of 2 days.
        </p>
        ...
        <p>
          ...
          guests from the Guatemala City airport to their hotels. Visit the link
          here to provide your flight information to the shuttle company and
          arrange transport.{" "}
        </p>
        <p>
          Guests will need to arrange their own transportation back to Guatemala
          City airport or onwards to their next destination. We recommend
          booking that transportation through Antigua Tours as well.
        </p>

        <h4>What is the best way to get from the hotel to the ceremony?</h4>
        <p>
          We will be providing shuttles from Pensativo House and Porta Hotel to
          the ceremony location. Shuttles will run between (add time when
          known).
        </p>
        ...
        <p>
          ...
          streets are cobbled and can pose a challenge for some. Be sure to wear
          comfortable walking shoes and watch your step.
        </p>
        <p>
          Tuk-tuks and taxis can take you to destinations within the city center
          for very little--negotiate the fare with the driver in advance.
        </p>
        ...
        <p>
          ...
          celebration. We hope this will allow you a much-deserved night off to
          celebrate with us!
        </p>
        <p>
        ...
        <p>
          ...
          receiving a complete two-dose COVID-19 vaccination course (or one dose
          for Johnson {"&"} Johnson), with the final dose being administered at
          least 2 weeks before your arrival.
        </p>
        <p>
          Travelers aged 10 and over require proof of a negative COVID-19 PCR or
          antigen test from a certified lab conducted no more than 3 days prior
          to check in at the airport or arrival at the land border.
        </p>
        <p>
        ...
        <p>
          We will continue to monitor the COVID-19 precautions in Guatemala and
          provide the most up-to-date information here.
        </p>

        <h4>What is the emergency contact number in Guatemala?</h4>
        <p>
          110 is the emergency number for police. Other emergency numbers can be
          found here.
        </p>
